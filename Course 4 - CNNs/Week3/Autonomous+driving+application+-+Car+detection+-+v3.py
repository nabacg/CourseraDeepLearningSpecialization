...
with tf.Session() as test_a:
    ...
    print(box_classes[0,0].eval())
    print(box_class_scores[0,0].eval())
    print((box_class_scores >= .6).shape)
   # print(box_scores[0,0].eval())
...
def yolo_non_max_suppression(scores, boxes, classes, max_boxes = 10, iou_threshold = 0.5):
    ...
    ### START CODE HERE ### (≈ 1 line)
    nms_indices = tf.image.non_max_suppression(boxes, scores, max_output_size=max_boxes, iou_threshold=
                                               iou_threshold)
    ### END CODE HERE ###
